...
int main(int argc, char* argv[])
{
    ...
    // cm.createDevice("voltage-source", std::make_pair<std::string, std::vector<double>>("V", {100}), {VB1, VB2});
    
    // cm.createDevice("resistor", std::make_pair<std::string, std::vector<double>>("r1", {5}), {R11, R12});
    // cm.createDevice("resistor", std::make_pair<std::string, std::vector<double>>("r2", {10}), {R21, R22});
    // cm.createDevice("resistor", std::make_pair<std::string, std::vector<double>>("r3", {30}), {R31, R32});
    // cm.createDevice("resistor", std::make_pair<std::string, std::vector<double>>("r4", {10}), {R41, R42});
    // cm.createDevice("resistor", std::make_pair<std::string, std::vector<double>>("r5", {20}), {R51, R52});    
    ...
    // cm.createDevice("resistor", std::make_pair<std::string, std::vector<double>>("r1", {1e3}), {R1, R2});
    // cm.createDevice("current-source", std::make_pair<std::string, std::vector<double>>("i1", {1e-3}), {I1, I2});
    ...
    // cm.createDevice("resistor", std::make_pair<std::string, std::vector<double>>("r1", {1e3}), {R1, R2});
    // cm.createDevice("capacitor", std::make_pair<std::string, std::vector<double>>("c1", {1e-6}), {C1, C2});
    // cm.createDevice("current-source", std::make_pair<std::string, std::vector<double>>("V", {1e-3}), {V1, V2});
